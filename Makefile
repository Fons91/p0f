...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Mar 3 17:04:50 2014
# Project:  p0f-QT-GUI.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile p0f-QT-GUI.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lpcap -lQtGui -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
moc_guip0f.cpp: ui_guip0f.h \
		...
		host.h \
		guip0f.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) guip0f.h -o moc_guip0f.cpp
...
ui_guip0f.h: guip0f.ui
	/usr/bin/uic-qt4 guip0f.ui -o ui_guip0f.h
